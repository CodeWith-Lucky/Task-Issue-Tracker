...
const AddTask = () => {
  ...
  const formatDateTimeForInput = (date) => {
    ...
    const formattedTimeForInput = `${ dateInIST.getUTCFullYear() }-${ String(
      ...
      2,
      "0"
    ) } ${ String(dateInIST.getUTCHours()).padStart(2, "0") }:${ String(
  ...
  useEffect(() => {
    ...
    if (task) {
      setFormData({
        ...task,
        taskCreatedDate: formatDateTimeForInput(new Date(task.taskCreatedDate)),
      });
    } else {
      const now = new Date();
...
return(
  ...
  <div className="container form-container mt-1" style={{overflowY:"auto"}}>
   ...
   onSubmit={ handleSubmit }
    ...
    <div className="row" >
      ...
      <div className="mb-3 col-lg-4 col-md-6 col-12">
        <label htmlFor="outletName" className="form-label font-weight-bold">Outlet Name</label>
        <input type="text" className="form-control" id="outletName"  name="outletName"  value={ formData.outletName }
              onChange={ handleChange }
              />
      </div>

      <div className="mb-3 col-lg-4 col-md-6 col-12" > 
        <label htmlFor="outletModule" className="form-label font-weight-bold">Property Module *</label>
        <select className="form-select" id="outletModule"   name="outletModule" value={ formData.outletModule }
      ...
      <div className="mb-3 col-lg-4 col-md-6 col-12">
        <label htmlFor="taskPriority" className="form-label font-weight-bold">Task Priority *</label>
        <select className="form-select" id="taskPriority"   name="taskPriority" value={ formData.taskPriority }
              onChange={ handleChange } required>
      ...
      <div className="mb-3 col-lg-4 col-md-6 col-12">
        <label htmlFor="clientName" className="form-label font-weight-bold">Client Name</label>
        <input type="text" className="form-control" id="clientName"   name="clientName" value={ formData.clientName }
              onChange={ handleChange } />
      </div>
      <div className="mb-3 col-lg-4 col-md-6 col-12">
        <label htmlFor="taskStatus" className="form-label font-weight-bold">Task Status *</label>
        <select className="form-select" id="taskStatus"  name="taskStatus" value={ formData.taskStatus }
              onChange={ handleChange } required>
      ...
      <div className="mb-3 col-lg-4 col-md-6 col-12">
        <label htmlFor="taskType" className="form-label font-weight-bold">Task Type *</label>
        <select className="form-select" id="taskType"   name = "taskType"value={ formData.taskType }
              onChange={ handleChange } required>
      ...
      <div className="mb-3 col-lg-4 col-md-6 col-12">
        <label htmlFor="clientNumber" className="form-label font-weight-bold">Client Number</label>
        <input type="text" className="form-control" id="clientNumber"  name = "clientNumber" value={ formData.clientNumber }
              onChange={ handleChange } />
      </div>
      <div className="mb-3 col-lg-4 col-md-6 col-12">
        <label htmlFor="taskCreatedBy" className="form-label font-weight-bold">Task Created By *</label>
        <select className="form-select" id="taskCreatedBy"  name="taskCreatedBy" value={ formData.taskCreatedBy }
              onChange={ handleChange } required>
      ...
      <div className="mb-3 col-lg-4 col-md-6 col-12">
        <label htmlFor="taskAssignTo" className="form-label font-weight-bold">Task Assign To *</label>
        <select className="form-select" id="taskAssignTo"   name="taskAssignTo"  value={ formData.taskAssignTo }
              onChange={ handleChange } required>
      ...
      <div className="mb-3 col-lg-4 col-md-6 col-12">
        <label htmlFor="taskCreatedDate" className="form-label font-weight-bold">Task Created Date *</label>
        <input type="datetime-local" className="form-control" id="taskCreatedDate"   name="taskCreatedDate"   value={ formData.taskCreatedDate }
              onChange={ handleChange } required />
      </div>  
      <div className="mb-3 col-md-12">
        <label htmlFor="taskTitle" className="form-label font-weight-bold">Task Title *</label>
        <input type="text" className="form-control" id="taskTitle"   name="taskTitle"   value={ formData.taskTitle }
              onChange={ handleChange }/>
      </div>
      <div className="mb-3 col-md-12">
        <label htmlFor="taskDetails" className="form-label font-weight-bold">Task Details *</label>
        <textarea className="form-control" id="taskDetails"  name="taskDetails" rows="5" value={ formData.taskDetails }
    ...
    {formData.taskId ? "Update Task" : "Submit Task"}
        ...
        <button type="button" className="btn btn-secondary ms-2" onClick={backList}>Back</button>
      </div>
    </div>
  </form>
</div>
